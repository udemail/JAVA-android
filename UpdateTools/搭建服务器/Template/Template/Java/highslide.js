var hs={
graphicsDir : '/template/images/highslide/graphics/',
restoreCursor : "/template/images/highslide/zoomout.cur",
fullExpandIcon : '/template/images/highslide/fullexpand.gif',
expandSteps : 10,
expandDuration : 250,
restoreSteps : 10,
restoreDuration : 250,
...
for(i=1;i<=8;i++){
var img=document.createElement('img')
img.src=hs.graphicsDir+hs.outlineType+"/"+i+".png"}}}}
...
return}
var src=hs.graphicsDir+this.outlineType+"/"+i+".png"
